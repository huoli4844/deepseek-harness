...
export declare class ReflectService {
     ...
     * @returns a disposer that unregisters the service.
     */
    provide(name: string, value?: any, check?: () => boolean): import("@deepseek-ai/cordis").Disposable<Promise<void>>;
    /**
     ...
     */
    accessor(name: string, options: Omit<Property.Accessor, 'type'>): import("@deepseek-ai/cordis").Disposable<Promise<void>>;
    /**
     * Expose selected members of a service directly on `ctx`.
     *
     ...
     */
    mixin(source: any, mixins: string[] | Dict<string>): import("@deepseek-ai/cordis").Disposable<Promise<void>>;
    /**
